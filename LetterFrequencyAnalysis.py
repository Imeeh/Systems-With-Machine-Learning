...
#############################################################################################
#                               Program by Imeh Akpan and  Nsar Garari                       #
#                               Student IDs:s183179 and s179582                                    #
#                                                                                           #
#############################################################################################
...
def letter_prominence(one, two, three, four):
    ...
    omnipresent_one = set(one)
    omnipresent_two = set(two)
    omnipresent_three = set(three)
    omnipresent_four = set(four)
...
def letter_consistency(list1, list2, list3, list4):
    ...
    first_set = set(list1) | set(list2)
    second_set = set(list3) | set(list2)
